...
namespace FluentJdf.Configuration {
    ...
    public class TemplateEngineSettingsBuilder : SettingsBuilderBase {
        ...
        public TemplateEngineSettingsBuilder CustomFormula(string name, Func<string> customFormula) {
            return CustomFormula(name, (Delegate)customFormula);
        }
        ...
        /// generated from the template provided a specific replacement value is not provided when
        /// calling Template.Generate().</param>
        public TemplateEngineSettingsBuilder CustomFormula(string name, Func<string, string> customFormula) {
            return CustomFormula(name, (Delegate)customFormula);
        }
        ...
        /// generated from the template provided a specific replacement value is not provided when
        /// calling Template.Generate().</param>
        public TemplateEngineSettingsBuilder CustomFormula(string name, Func<string, string, string> customFormula) {
            return CustomFormula(name, (Delegate)customFormula);
        }
        ...
        /// generated from the template provided a specific replacement value is not provided when
        /// calling Template.Generate().</param>
        public TemplateEngineSettingsBuilder CustomFormula(string name, Func<string, string, string, string> customFormula) {
            return CustomFormula(name, (Delegate)customFormula);
        }
        ...
        /// generated from the template provided a specific replacement value is not provided when
        /// calling Template.Generate().</param>
        public TemplateEngineSettingsBuilder CustomFormula(string name, Func<string, string, string, string, string> customFormula) {
            return CustomFormula(name, (Delegate)customFormula);
        }
        ...
        /// generated from the template provided a specific replacement value is not provided when
        /// calling Template.Generate().</param>
        public TemplateEngineSettingsBuilder CustomFormula(string name, Func<string, string, string, string, string, string> customFormula) {
            return CustomFormula(name, (Delegate)customFormula);
        }

        TemplateEngineSettingsBuilder CustomFormula(string name, Delegate customFormula) {
