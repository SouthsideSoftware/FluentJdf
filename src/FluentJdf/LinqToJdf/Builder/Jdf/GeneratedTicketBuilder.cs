...
namespace FluentJdf.LinqToJdf.Builder.Jdf {
    ...
    public class GeneratedTicketBuilder {
        ...
        /// <remarks>The result of the custom function will be used for replacement if
        /// there is no replacement defined in the name values for the variable.</remarks>
        public GeneratedTicketBuilder CustomFormula(string name, Func<string, string> customFunction) {
            generatedDocumentBuilderHelper.CustomFormula(name, customFunction);
            return this;
        }
        ...
        /// <remarks>The result of the custom function will be used for replacement if
        /// there is no replacement defined in the name values for the variable.</remarks>
        public GeneratedTicketBuilder CustomFormula(string name, Func<string, string, string> customFunction) {
            generatedDocumentBuilderHelper.CustomFormula(name, customFunction);
            return this;
        }
        ...
        /// <remarks>The result of the custom function will be used for replacement if
        /// there is no replacement defined in the name values for the variable.</remarks>
        public GeneratedTicketBuilder CustomFormula(string name, Func<string, string, string, string> customFunction) {
            generatedDocumentBuilderHelper.CustomFormula(name, customFunction);
            return this;
        }
        ...
        /// <remarks>The result of the custom function will be used for replacement if
        /// there is no replacement defined in the name values for the variable.</remarks>
        public GeneratedTicketBuilder CustomFormula(string name, Func<string, string, string, string, string> customFunction) {
            generatedDocumentBuilderHelper.CustomFormula(name, customFunction);
            return this;
        }
        ...
        /// <remarks>The result of the custom function will be used for replacement if
        /// there is no replacement defined in the name values for the variable.</remarks>
        public GeneratedTicketBuilder CustomFormula(string name, Func<string, string, string, string, string, string> customFunction) {
            generatedDocumentBuilderHelper.CustomFormula(name, customFunction);
            return this;
        }
    }
