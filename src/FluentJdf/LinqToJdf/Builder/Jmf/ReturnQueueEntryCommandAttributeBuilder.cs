...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	public partial class ReturnQueueEntryCommandAttributeBuilder : JmfAttributeBuilderBase {
		...
		/// <returns></returns>
		public ReturnQueueEntryCommandAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public ReturnQueueEntryCommandAttributeBuilder JdfVersion(string jdfVersion) {
