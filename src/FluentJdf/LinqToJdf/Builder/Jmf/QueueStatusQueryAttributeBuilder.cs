...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	/// </summary>
	public partial class QueueStatusQueryAttributeBuilder : JmfAttributeBuilderBase {
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		/// <returns></returns>
		public QueueStatusQueryAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public QueueStatusQueryAttributeBuilder JdfVersion(string jdfVersion) {
