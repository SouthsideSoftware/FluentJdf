...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	public partial class SetQueueEntryPositionCommandAttributeBuilder : JmfAttributeBuilderBase {
		...
		/// <returns></returns>
		public SetQueueEntryPositionCommandAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public SetQueueEntryPositionCommandAttributeBuilder JdfVersion(string jdfVersion) {
