...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	/// </summary>
	public partial class TrackQueryAttributeBuilder : JmfAttributeBuilderBase {
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		/// <returns></returns>
		public TrackQueryAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public TrackQueryAttributeBuilder JdfVersion(string jdfVersion) {
