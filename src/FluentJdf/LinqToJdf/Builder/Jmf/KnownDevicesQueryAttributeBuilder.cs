...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	/// </summary>
	public partial class KnownDevicesQueryAttributeBuilder : JmfAttributeBuilderBase {
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		/// <returns></returns>
		public KnownDevicesQueryAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public KnownDevicesQueryAttributeBuilder JdfVersion(string jdfVersion) {
