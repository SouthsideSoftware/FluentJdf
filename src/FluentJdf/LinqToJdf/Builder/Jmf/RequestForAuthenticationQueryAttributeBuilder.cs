...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	public partial class RequestForAuthenticationQueryAttributeBuilder : JmfAttributeBuilderBase {
		...
		/// <returns></returns>
		public RequestForAuthenticationQueryAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public RequestForAuthenticationQueryAttributeBuilder JdfVersion(string jdfVersion) {
