...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	/// </summary>
	public partial class ShutDownCommandAttributeBuilder : JmfAttributeBuilderBase {
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		/// <returns></returns>
		public ShutDownCommandAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public ShutDownCommandAttributeBuilder JdfVersion(string jdfVersion) {
