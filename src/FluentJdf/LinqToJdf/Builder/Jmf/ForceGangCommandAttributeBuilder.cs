...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	/// </summary>
	public partial class ForceGangCommandAttributeBuilder : JmfAttributeBuilderBase {
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		/// <returns></returns>
		public ForceGangCommandAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public ForceGangCommandAttributeBuilder JdfVersion(string jdfVersion) {
