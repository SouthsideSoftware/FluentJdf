...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	public partial class HoldQueueEntryCommandAttributeBuilder : JmfAttributeBuilderBase {
		...
		/// <returns></returns>
		public HoldQueueEntryCommandAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public HoldQueueEntryCommandAttributeBuilder JdfVersion(string jdfVersion) {
