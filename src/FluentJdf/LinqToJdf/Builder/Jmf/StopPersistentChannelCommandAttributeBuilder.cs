...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	/// </summary>
	public class StopPersistentChannelCommandAttributeBuilder : JmfAttributeBuilderBase {
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		/// <returns></returns>
		public StopPersistentChannelCommandAttributeBuilder Ticket(Ticket ticket) {
