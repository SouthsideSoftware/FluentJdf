...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	public partial class ResubmitQueueEntryCommandAttributeBuilder : JmfAttributeBuilderBase {
		...
		/// <returns></returns>
		public ResubmitQueueEntryCommandAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public ResubmitQueueEntryCommandAttributeBuilder JdfVersion(string jdfVersion) {
