...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	public partial class ResumeQueueEntryCommandAttributeBuilder : JmfAttributeBuilderBase {
		...
		/// <returns></returns>
		public ResumeQueueEntryCommandAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public ResumeQueueEntryCommandAttributeBuilder JdfVersion(string jdfVersion) {
