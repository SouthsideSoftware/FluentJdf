...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	/// <summary>
	/// Build attributes for RemoveQueueEntryCommandBuilder.
	/// </summary>
	public partial class RemoveQueueEntryCommandAttributeBuilder : JmfAttributeBuilderBase {
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="builder"></param>
		internal RemoveQueueEntryCommandAttributeBuilder(RemoveQueueEntryCommandBuilder builder)
			: base(builder) {
		}
		...
		/// <returns></returns>
		public RemoveQueueEntryCommandAttributeBuilder Attribute(XName name, string value) {
		...
		/// <returns></returns>
		public RemoveQueueEntryCommandAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public RemoveQueueEntryCommandAttributeBuilder Id(string id) {
