...
namespace FluentJdf.LinqToJdf.Builder.Jmf {
	...
	public partial class SubmissionMethodsQueryAttributeBuilder : JmfAttributeBuilderBase {
		...
		/// <returns></returns>
		public SubmissionMethodsQueryAttributeBuilder AddAttribute(string name, string value) {
			ParameterCheck.ParameterRequired(name, "name");
		...
		/// <returns></returns>
		public SubmissionMethodsQueryAttributeBuilder JdfVersion(string jdfVersion) {
