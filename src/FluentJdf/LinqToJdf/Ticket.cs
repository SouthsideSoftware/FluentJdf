...
namespace FluentJdf.LinqToJdf {
    ...
    public class Ticket : FluentJdfDocumentBase {
        ...
        /// <returns></returns>
        public static new Ticket Load(Stream stream, LoadOptions options) {
        ...
        /// <returns></returns>
        public static new Ticket Load(TextReader textReader) {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static new Ticket Load(TextReader textReader, LoadOptions options) {
        ...
        /// <returns></returns>
        public static new Ticket Load(XmlReader reader) {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static new Ticket Load(XmlReader reader, LoadOptions options) {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static new Ticket Load(string uri, LoadOptions options) {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static new Ticket Parse(string text, LoadOptions options) {
