...
namespace FluentJdf.Resources {
    ...
    internal class Messages {
        ...
        /// </summary>
        internal static string FileTransmitter_Transmit_AtLeastOneTransmissionPartIsRequired {
            get {
                return ResourceManager.GetString("FileTransmitter_Transmit_AtLeastOneTransmissionPartIsRequired", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string FileTransmitter_Transmit_RequiresHttpUrl {
            get {
                return ResourceManager.GetString("FileTransmitter_Transmit_RequiresHttpUrl", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The id &apos;{0}&apos; already exists on a resource not matching the current element..
        /// </summary>
        internal static string TheId0AlreadyExistsOnAResourceNotMatchingTheCurrent {
            get {
                return ResourceManager.GetString("TheId0AlreadyExistsOnAResourceNotMatchingTheCurrent", resourceCulture);
            }
        }
