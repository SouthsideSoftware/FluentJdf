...
namespace Jdp.Jdf.Tests.Unit.LinqToJdf.JdfElementExtensions {
    ...
    public class when_creating_intent_node_from_resource_in_jdf_node {
        ...
        It should_have_job_part_id_on_the_newly_created_intent_node = () => newIntent.Document.Root.Descendants(Element.JDF).FirstOrDefault().GetJobPartId().ShouldNotBeNull();
