...
namespace Jdp.Jdf.Tests.Unit.LinqToJdf.JdfElementExtensions {
    ...
    public class when_creating_an_output_of_a_new_resource {
        ...
        It should_have_binding_as_output = () => jdf.ResourceLinkPool().Element(Resource.BindingIntent.LinkName()).GetUsage().ShouldEqual(ResourceUsage.Output);
        ...
        It should_have_folding_as_output = () => jdf.ResourceLinkPool().Element(Resource.FoldingIntent.LinkName()).GetUsage().ShouldEqual(ResourceUsage.Output);
