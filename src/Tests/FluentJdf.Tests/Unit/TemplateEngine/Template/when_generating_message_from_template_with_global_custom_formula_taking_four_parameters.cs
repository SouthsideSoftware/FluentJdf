...
namespace FluentJdf.Tests.Unit.TemplateEngine.Template {
    ...
    public class when_generating_message_from_template_with_global_custom_formula_taking_four_parameters {
        ...
        Establish context = () => {
            ...
            FluentJdf.Configuration.FluentJdfLibrary.Settings.WithTemplateEngineSettings()
                .CustomFormula("customTestFunction", (parm1, parm2, parm3, parm4) => string.Format("this is a test {0}, {1}, {2}, {3}", parm1, parm2, parm3, parm4));
        };
