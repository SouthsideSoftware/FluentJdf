...
namespace FluentJdf.Tests.Unit.LinqToJdf.JdfElementExtensions {
    ...
    public class when_creating_jdf_nodes_with_configuration_for_no_job_id
    {
        static Ticket ticket;

        Establish context = () => FluentJdf.Configuration.FluentJdfLibrary.Settings.WithJdfAuthoringSettings().GenerateJobId(false);
