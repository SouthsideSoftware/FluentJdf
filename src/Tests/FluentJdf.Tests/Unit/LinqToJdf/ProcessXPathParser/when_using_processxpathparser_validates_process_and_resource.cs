...
namespace FluentJdf.Tests.Unit.LinqToJdf.ProcessXPathParser {
    ...
    public class when_using_processxpathparser_validates_process_and_resource {

        static l.ProcessXPathParser parser;

        Because of = () => parser = l.ProcessXPathParser.Parse("process:DigitalPrinting/DigitalPrintingParams[@usage=output]/./rest");
