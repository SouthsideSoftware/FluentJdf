...
namespace FluentJdf.Tests.Unit.LinqToJdf.ProcessXPathParser {
    ...
    public class when_using_processxpathparser_no_usage_type_no_xpath {
        static l.ProcessXPathParser parser;

        Because of = () => parser = l.ProcessXPathParser.Parse("process:DigitalPrinting/DigitalPrintingParams");
