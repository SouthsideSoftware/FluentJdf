...
namespace FluentJdf.Tests.Unit.LinqToJdf.XElementExtensions {
    ...
    public class when_getting_xml_type_of_various_nodes {
        It should_get_jdf_xml_type_from_jdf_node = () => Ticket.CreateIntent().Element.XmlType().ShouldEqual(XmlType.Jdf);
        ...
        It should_get_jdf_xml_type_from_document_having_jdf_root = () => Ticket.CreateIntent().Element.Document.XmlType().ShouldEqual(XmlType.Jdf);
    }
}