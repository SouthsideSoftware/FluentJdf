...
namespace FluentJdf.Tests.Unit.Encoding.XmlTransmissionPart {
    ...
    public class when_xml_transmission_part_created_from_jdf_document {
        static FluentJdf.Encoding.XmlTransmissionPart transmissionPart;

        Because of = () => transmissionPart = new FluentJdf.Encoding.XmlTransmissionPart(new XDocument(new XElement(Element.JDF)), "test1");
