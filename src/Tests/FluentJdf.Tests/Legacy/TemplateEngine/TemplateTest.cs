...
namespace FluentJdf.Tests.Legacy.TemplateEngine
{
	...
	public class JdfCreatorTest
	{
		...
		public void TestSimpleCreateFromTemplate()
		{
			...
			jdfNode2 = generated.Root;
			AssertionHelper.IsTrue("Tree created from template is currently not null", generated != null);
			AssertionHelper.IsTrue("The value of 'JobID' attribute will be 'fooey'", jdfNode2.GetJobId() == "fooey");
			AssertionHelper.IsTrue("The number of elements contained in both roots should be the same", jdfNode1.Descendants().Count() == jdfNode2.Descendants().Count());
            ...
            //AssertionHelper.IsTrue("The value of 'amount' attribute should be 101.36",  (double)resource1.Attributes["Amount"].Value == 101.36);
            ...
            //AssertionHelper.IsTrue("The value of 'preferred' attribute should be 11",  (int)element1.Attributes["Preferred"].Value == 11);
            ...
            //AssertionHelper.IsTrue("The root node does not have a descriptive name because jdfDefault generated null", 
            //    !generated.Root.Attributes.IsAttributeNonNull("DescriptiveName"));

            //AssertionHelper.IsTrue("The value of Template in the root is false", generated.Root.Attributes["Template"].ToString() == "false");
		}

        //[Test]
        //public void Case14110()
        //{
        //    StringDictionary nameValues = new StringDictionary();
        //    nameValues.Add("IntegerSpan", "11");
        //    nameValues.Add("Amount1","101.36");
        //    Config.DefaultVerboseTreeSave = true;
        //    try
        //    {
        ...
        //        string tempFileName = Path.Combine(Config.TempFolder, Guid.NewGuid().ToString() + ",jdf");
        //        generated.Save(tempFileName);
        //        StreamReader reader = new StreamReader(tempFileName);
        //        try
        //        {
        //            string content = reader.ReadToEnd();
        //            Assert.IsTrue(content.IndexOf("SettingsPolicy") > -1, "SettingsPolicy attribute found");
        //        } 
        //        finally 
        //        {
        //            reader.Close();
        ...
        //    Config.DefaultVerboseTreeSave = false;
        //    try
        //    {
        //        JdfTree generated = JdfCreator.CreateFromTemplate(Path.Combine(Config.JdpTestDataFolder, "sampleJDFTemplate.xml"), nameValues, "fooey");
        //        string tempFileName = Path.Combine(Config.TempFolder, Guid.NewGuid().ToString() + ",jdf");
        ...
        //        {
        //            string content = reader.ReadToEnd();
        //            Assert.IsTrue(content.IndexOf("SettingsPolicy") == -1, "SettingsPolicy attribute not found");
        //        } 
        //        finally 
        //        {
        //            reader.Close();
        ...
        //[Test]
        //public void TestSimpleCreateFromTemplateWithCache()
        //{
        //    JdfElement jdfNode1;
        //    JdfElement jdfNode2;
        ...
        //    nameValues.Add("IntegerSpan", "11");
        //    nameValues.Add("Amount1","101");
        //    JdfTree generated = JdfCreator.CreateFromTemplate(Path.Combine(Config.JdpTestDataFolder, "sampleJDFTemplate.xml"), nameValues, "fooey", true, true);
        //    jdfNode2 = (JdfElement)generated.Root;
        //    AssertionHelper.IsTrue("Tree created from template is currently not null", generated != null);
        //    AssertionHelper.IsTrue("The value of 'JobID' attribute will be 'fooey'", jdfNode2.Attributes["JobID"].ToString().CompareTo("fooey") == 0);
        ...
        //[Test]
        //public void TestSimpleCreateFromTemplateWithCacheAndNoSchema()
        //{
        //    JdfElement jdfNode1;
        //    JdfElement jdfNode2;
        ...
        //    nameValues.Add("IntegerSpan", "11");
        //    nameValues.Add("Amount1","101");
        //    JdfTree generated = JdfCreator.CreateFromTemplate(Path.Combine(Config.JdpTestDataFolder, "sampleJDFTemplate.xml"), nameValues, SchemaPriority.None, "fooey", true, true);
        //    jdfNode2 = (JdfElement)generated.Root;
        //    AssertionHelper.IsTrue("Tree created from template is currently not null", generated != null);
        //    AssertionHelper.IsTrue("The value of 'JobID' attribute will be 'fooey'", jdfNode2.Attributes["JobID"].ToString().CompareTo("fooey") == 0);
        //    AssertionHelper.IsTrue("The number of elements contained in both roots should be the same", jdfNode1.Count == jdfNode2.Count);
        ...
        //[Test]
        //public void CreateFromTemplateNoFixupWithCache()
        //{
        //    JdfElement jdfNode1;
        //    JdfElement jdfNode2;
        ...
        //    nameValues.Add("IntegerSpan", "11");
        //    nameValues.Add("Amount1","101");
        //    JdfTree generated = JdfCreator.CreateFromTemplate(Path.Combine(Config.JdpTestDataFolder, "sampleJDFTemplate.xml"), nameValues, false, true);
        //    jdfNode2 = (JdfElement)generated.Root;
        //    AssertionHelper.IsTrue("Tree created from template is currently not null", generated != null);
        //    AssertionHelper.IsTrue("The number of elements contained in both roots should be the same", jdfNode1.Count == jdfNode2.Count);
        ...
        //[Test]
        //public void AutoCacheAndInvalidate()
        //{
        //    StringDictionary nameValues = new StringDictionary();
        //    nameValues.Add("IntegerSpan", "11");
        //    nameValues.Add("Amount1","101");
        ...
        //    string fileName = Path.Combine(Config.JdpTestDataFolder, "sampleJDFTemplate.xml");
        //    JdfTree generated = JdfCreator.CreateFromTemplate(fileName, nameValues, "fooey");
        ...
        //    string cacheKey = "Tp_" + fileName;
        //    AssertionHelper.IsTrue("The template is cached", Cache.GetObject(cacheKey) != null);

        //    JdfCreator.InvalidateCache(fileName);
        //    AssertionHelper.IsTrue("The template is not cached", Cache.GetObject(cacheKey) == null);
        //}

        //[Test]
        //public void AutoCacheDependency()
        //{
        //    //setup a copy of the test template file for use in the test
        //    string sourceFileName = Path.Combine(Config.JdpTestDataFolder, "sampleJDFTemplate.xml");
        //    string fileName = Path.Combine(Config.JdpTestDataFolder, "copiedTemplate.xml");
        ...
        //        //Copy the file again to invalidate the cache
        //        if (File.Exists(fileName))
        //        {
        ...
        //        //Sleep the thread for a couple of milliseconds to give the dependency a chance to work
        ...
        //[Test]
        //public void OverrideAutoCacheDependency()
        //{
        //    //setup a copy of the test template file for use in the test
        //    string sourceFileName = Path.Combine(Config.JdpTestDataFolder, "sampleJDFTemplate.xml");
        //    string fileName = Path.Combine(Config.JdpTestDataFolder, "copiedTemplate.xml");
        ...
        //        JdfTree referenceTree = new JdfTree(fileName);
        ...
        //        nameValues.Add("val", "FOOL");
        //        nameValues.Add("ts", "2000-11-01T12:46:56+01:00");
        //        JdfTree generated = JdfCreator.CreateFromTemplate(fileName, nameValues, null,
        //            SchemaPriority.None, "job", true, true, false);
        ...
        //        AssertionHelper.IsTrue("The template is still cached", Cache.GetObject(cacheKey) != null);
        //        Template.InvalidateCache(fileName);
        //        AssertionHelper.IsTrue("The template is not cached", Cache.GetObject(cacheKey) == null);
        //    } 
        //    finally 
        //    {
        ...
        //[Test]
        //public void RelativeTemplatePathWithCache()
        //{
        //    StringDictionary nameValues = new StringDictionary();
        //    nameValues.Add("IntegerSpan", "11");
        //    nameValues.Add("Amount1","101");
        ...
        //    nameValues.Add("ts", "2000-11-01T12:46:56+01:00");
        //    string sourceFileName = Path.Combine(Config.JdpTestDataFolder, "sampleJDFTemplate.xml");
        //    string destFileName = "newTemplate.xml";
        ...
        //    try
        //    {
        //        JdfTree generated = JdfCreator.CreateFromTemplate(destFileName, nameValues, "fooey");
        ...
        //        string cacheKey = "Tp_" + Path.GetFullPath(destFileName);
        //        AssertionHelper.IsTrue("The template is cached", Cache.GetObject(cacheKey) != null);

        //        Template.InvalidateCache(destFileName);
        //        AssertionHelper.IsTrue("The template is not cached", Cache.GetObject(cacheKey) == null);
        //    } 
        //    finally 
        //    {
        ...
        //[Test]
        //public void AutoCacheDependencyWithRelativePath()
        //{
        //    //setup a copy of the test template file for use in the test
        //    string sourceFileName = Path.Combine(Config.JdpTestDataFolder, "sampleJDFTemplate.xml");
        //    string fileName = "copiedTemplate.xml";
        //    if (File.Exists(fileName))
        //    {
        //        File.SetAttributes(fileName, FileAttributes.Normal);
        //    }
        ...
        //        string cacheKey = "Tp_" + Path.GetFullPath(fileName);
        //        AssertionHelper.IsTrue("The template is cached", Cache.GetObject(cacheKey) != null);
        ...
        //{
        //    StringDictionary nameValues = new StringDictionary();
        //    JdfTree generated = JdfCreator.CreateFromTemplate(Path.Combine(Config.JdpTestDataFolder, "PRN200Template.xml"), nameValues, "fooey");
        //    AssertionHelper.IsTrue("The resulting tree is valid", generated.IsTreeValid);
        //    AssertionHelper.IsTrue("The StepDocs = '1 1'", generated.Root[1][0].Attributes["StepDocs"].ToString() == "1 1");
        //}

        ///// <summary>
        ///// Resolve issue: Version of JDF during merge of template causes trouble 
        ///// </summary>
        //[Test]
        //public void PRN183()
        //{
        //    //Create a job ticket
        //    JdfTree ticketTree = new JdfTree(Path.Combine(Config.JdpTestDataFolder, "PRN183.xml"));
        ...
        //    nameValues.Add("val", "FOOL");
        //    nameValues.Add("ts", "2000-11-01T12:46:56+01:00");
        //    //Create a template ticket with no version attribute in JDF node
        //    JdfTree templateTree = JdfCreator.CreateFromTemplate((Path.Combine(Config.JdpTestDataFolder, "PRN183Template.xml")), nameValues, SchemaPriority.None, false, true);

        //    //Paste the template ticket under the root of the job ticket
        //    ticketTree.Paste(templateTree, ticketTree.Root);
        //    //Test if the tree is valid
        //    AssertionHelper.IsTrue(ticketTree.Root.IsTreeValid, "The tree root of the job ticket is valid");

        //    JdfTree ticketTree2 = new JdfTree(Path.Combine(Config.JdpTestDataFolder, "PRN183Template.xml"));
        //    Assert.IsFalse(ticketTree2.Root.IsTreeValid, "The tree root of the template ticket is invalid");
        //}
